    ...
    return (
        <div>
            <Carousel className="w-full h-64 ">
                ...
                <div className=" bg-blue-500 w-full h-full rounded-2xl"></div>
                ...
                <div className="flex lg:px-24 flex-wrap">
                    <div className={clsx(style.categoryItem)}>
                        <div className={clsx(style.content)}>
                            <img
                                alt="smartphone"
                                src="https://hpcluxury.com.vn/wp-content/uploads/2023/07/iPhone-15-pro-titanium-blue-png.png"
                            ></img>
            ...
            <div id="DiscountedProduct" className="mt-10 rounded-2xl">
                ...
                <ScrollList className={clsx('relative py-4')} leftBtn rightBtn>
                    <div
                        className={clsx(
                            'xl:w-1/5 lg:w-1/4 sm:w-1/3 ssm:w-1/2 ssm:px-1 sm:px-3 inline-block',
                            style.productXl,
                        )}
                    >
                        <ProductItem className="bg-white border border-gray-200 rounded-lg" />
                    </div>
                    <div
                        className={clsx(
                            'xl:w-1/5 lg:w-1/4 sm:w-1/3 ssm:w-1/2 ssm:px-1 sm:px-3 inline-block',
